...
```bash
uv run .agents/skills/pixel-snapper/scripts/pixel_snapper.py \
  input.png \
  output.png
```
...
```bash
chmod +x .agents/skills/pixel-snapper/scripts/pixel_snapper.py

.agents/skills/pixel-snapper/scripts/pixel_snapper.py \

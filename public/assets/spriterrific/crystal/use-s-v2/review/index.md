...
Foreground components recovered from the full pose board and ordered by the declared grid. These recovered components are the runtime source. Review image size: `970x204`.
...
Before/after comparison showing recovered components against raw variable-size pixel snap outputs. Review image size: `786x352`.
...
Before/after comparison for cleanup output to shared-scale layout input. Review image size: `786x352`.
